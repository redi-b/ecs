...
test("GET /onboarding/handle checks shop handle availability through the Platform API", async () => {
  ...
  const response = await GET(
    new Request("http://app.lvh.me/onboarding/handle?handle=addis-pantry"),
  );
