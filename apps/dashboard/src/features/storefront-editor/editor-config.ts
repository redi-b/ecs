...
export type { StorefrontDraft, PublicationStatus } from "@/features/storefront-editor/editor-state";
...
export const FONT_OPTIONS = ["Inter", "Geist", "Manrope", "DM Sans", "Nunito Sans", "Source Sans 3"];
