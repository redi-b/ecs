...
export const nexahubV1EditorSchema = {
  ...
  sections: [
    ...
    },
    {
      ...
      fields: [
        {
          path: "home.featuredItem.enabled",
          prop: "nexahubFeaturedEnabled",
          label: "Show section",
          kind: "boolean",
        },
        {
          path: "home.featuredItem.eyebrow",
          prop: "nexahubFeaturedEyebrow",
          label: "Eyebrow",
          kind: "text",
        },
        {
        ...
        },
        {
          ...
          maxItems: 5,
          helpText:
            "Choose and order up to five carousel products, or leave empty to use the newest available products.",
        },
        {
          path: "home.featuredItem.imageAssetId",
          prop: "nexahubFeaturedImage",
      ...
      fields: [
        {
          ...
          prop: "nexahubCategoriesEnabled",
          label: "Show section",
          kind: "boolean",
        },
        {
          path: "home.categories.eyebrow",
          prop: "nexahubCategoriesEyebrow",
          label: "Eyebrow",
          kind: "text",
        },
        {
          path: "home.categories.title",
          prop: "nexahubCategoriesTitle",
          label: "Title",
          kind: "text",
        },
        {
          path: "home.categories.collectionIds",
          prop: "nexahubCategoryCollections",
          label: "Collections",
          kind: "collections",
          maxItems: 6,
          helpText:
            "Choose up to six collections, or leave empty to use the current catalog collections. Collection imagery is managed in Products > Collections.",
          preview: { strategy: "variant-options", variants: ["featured", "standard"] },
        },
      ],
    },
    {
      ...
      fields: [
        {
          path: "home.bestSellers.enabled",
          prop: "nexahubProductsEnabled",
          label: "Show section",
          kind: "boolean",
        },
        {
          path: "home.bestSellers.title",
          prop: "nexahubProductsTitle",
          label: "Section title",
          kind: "text",
        },
        {
          path: "home.bestSellers.productIds",
          prop: "nexahubProductIds",
          label: "Products",
          kind: "products",
          maxItems: 24,
          helpText:
    ...
    },
    {
      ...
      fields: [
        {
          path: "home.quality.enabled",
          prop: "nexahubQualityEnabled",
          label: "Show section",
          kind: "boolean",
        },
        {
          path: "home.quality.eyebrow",
          prop: "nexahubQualityEyebrow",
          label: "Eyebrow",
          kind: "text",
        },
        { path: "home.quality.title", prop: "nexahubQualityTitle", label: "Title", kind: "text" },
        {
          path: "home.quality.body",
          prop: "nexahubQualityBody",
          label: "Description",
          kind: "textarea",
        },
        {
          path: "home.quality.accordion1Title",
          prop: "nexahubQualityAccordion1Title",
          label: "Feature 1 title",
          kind: "text",
        },
        {
          path: "home.quality.accordion1Body",
          prop: "nexahubQualityAccordion1Body",
          label: "Feature 1 description",
          kind: "textarea",
        },
        {
          path: "home.quality.accordion2Title",
          prop: "nexahubQualityAccordion2Title",
          label: "Feature 2 title",
          kind: "text",
        },
        {
          path: "home.quality.accordion2Body",
          prop: "nexahubQualityAccordion2Body",
          label: "Feature 2 description",
          kind: "textarea",
        },
        {
          path: "home.quality.accordion3Title",
          prop: "nexahubQualityAccordion3Title",
          label: "Feature 3 title",
          kind: "text",
        },
        {
          path: "home.quality.accordion3Body",
          prop: "nexahubQualityAccordion3Body",
          label: "Feature 3 description",
          kind: "textarea",
        },
        {
          path: "home.quality.accordion4Title",
          prop: "nexahubQualityAccordion4Title",
          label: "Feature 4 title",
          kind: "text",
        },
        {
          path: "home.quality.accordion4Body",
          prop: "nexahubQualityAccordion4Body",
          label: "Feature 4 description",
          kind: "textarea",
        },
        {
          path: "home.quality.imageAssetId",
          prop: "nexahubQualityImage",
          label: "Image",
          kind: "image",
        },
      ],
      ...
      fields: [
        {
          ...
          prop: "nexahubContactEnabled",
          label: "Show section",
          kind: "boolean",
        },
        {
          path: "home.contact.eyebrow",
          prop: "nexahubContactEyebrow",
          label: "Eyebrow",
          kind: "text",
        },
        { path: "home.contact.title", prop: "nexahubContactTitle", label: "Title", kind: "text" },
        {
          path: "home.contact.body",
          prop: "nexahubContactBody",
          label: "Description",
          kind: "textarea",
        },
        {
          path: "home.contact.imageAssetId",
          prop: "nexahubContactImage",
          label: "Image",
          kind: "image",
        },
        {
          path: "home.contact.ctaLabel",
          prop: "nexahubContactCtaLabel",
          label: "Button label",
          kind: "text",
        },
        {
